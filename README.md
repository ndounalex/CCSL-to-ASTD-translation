...
- The "environment" folder contains the source code for our environment module, which is responsible for generating execution traces for the various test cases.
