...
{
  Timer right_clock_D_causality_C = current_time;
...
{
  Timer left_clock_P_causality_Z = current_time;
...
int    Step()
{
	...
	if((ts_TCS.autState == diagnostic && ts_TCS.diagnostic_to_control.expired(1E11, current_time) ))
	{
		...
		ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_P_alternateWith_Z.left_clock_P_causality_Z.reset_clock(last_event_time);
...
{
	int  exec = 0;
	if((ts_TCS.autState == Control && (ts_TCS.ts_Control.autState == ControlExecution && ((((((ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_T1.ts_InsertOrRemoveRod.ts_i_alternatesWith_r.ts_r_precede_i.autState == S0 && ( ((history[ts_TCS.i]-history[ts_TCS.r]) != 2) || (p0[ts_TCS.i] == '0') ) ) && (ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_T1.ts_InsertOrRemoveRod.ts_i_alternatesWith_r.ts_IbeforeR.autState == S0 && ( ((history[ts_TCS.r]-history[ts_TCS.i]) != 0) || (p0[ts_TCS.r] == '0') ) )) && (ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_T1.ts_InsertOrRemoveRod.ts_exclusion.autState == S0 && ((p0[ts_TCS.i] == '0') || (p0[ts_TCS.r] == '0')) )) && (ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_T1.ts_iUr.autState == S0 && ( (p0[ts_TCS.z]-'0') == ((p0[ts_TCS.r]-'0')+(p0[ts_TCS.i]-'0')) ) )) && ((ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_P_alternateWith_Z.ts_P_causality_Z.autState == S0 && ( (history[ts_TCS.p]+(p0[ts_TCS.p]-'0')) >= (history[ts_TCS.z]+(p0[ts_TCS.z]-'0')) ) ) && (ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_P_alternateWith_Z.ts_P_precede_Z.autState == S0 && ( ((history[ts_TCS.p]-history[ts_TCS.z]) != 1) || (p0[ts_TCS.p] == '0') ) ))) && ((ts_TCS.ts_Control.ts_ControlExecution.ts_P_discretizedBy_10.autState == S0 && ((p0[ts_TCS.p] == '0') &&! (ts_TCS.ts_Control.ts_ControlExecution.ts_P_discretizedBy_10.periodic_sense_timer.expired(1E10, current_time))) ) || (ts_TCS.ts_Control.ts_ControlExecution.ts_P_discretizedBy_10.autState == S0 && ((p0[ts_TCS.p] == '1') && (ts_TCS.ts_Control.ts_ControlExecution.ts_P_discretizedBy_10.periodic_sense_timer.expired(1E10, current_time))) ))))))
	{
		if((ts_TCS.ts_Control.autState == ControlExecution && ((((((ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_T1.ts_InsertOrRemoveRod.ts_i_alternatesWith_r.ts_r_precede_i.autState == S0 && ( ((history[ts_TCS.i]-history[ts_TCS.r]) != 2) || (p0[ts_TCS.i] == '0') ) ) && (ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_T1.ts_InsertOrRemoveRod.ts_i_alternatesWith_r.ts_IbeforeR.autState == S0 && ( ((history[ts_TCS.r]-history[ts_TCS.i]) != 0) || (p0[ts_TCS.r] == '0') ) )) && (ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_T1.ts_InsertOrRemoveRod.ts_exclusion.autState == S0 && ((p0[ts_TCS.i] == '0') || (p0[ts_TCS.r] == '0')) )) && (ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_T1.ts_iUr.autState == S0 && ( (p0[ts_TCS.z]-'0') == ((p0[ts_TCS.r]-'0')+(p0[ts_TCS.i]-'0')) ) )) && ((ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_P_alternateWith_Z.ts_P_causality_Z.autState == S0 && ( (history[ts_TCS.p]+(p0[ts_TCS.p]-'0')) >= (history[ts_TCS.z]+(p0[ts_TCS.z]-'0')) ) ) && (ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_P_alternateWith_Z.ts_P_precede_Z.autState == S0 && ( ((history[ts_TCS.p]-history[ts_TCS.z]) != 1) || (p0[ts_TCS.p] == '0') ) ))) && ((ts_TCS.ts_Control.ts_ControlExecution.ts_P_discretizedBy_10.autState == S0 && ((p0[ts_TCS.p] == '0') &&! (ts_TCS.ts_Control.ts_ControlExecution.ts_P_discretizedBy_10.periodic_sense_timer.expired(1E10, current_time))) ) || (ts_TCS.ts_Control.ts_ControlExecution.ts_P_discretizedBy_10.autState == S0 && ((p0[ts_TCS.p] == '1') && (ts_TCS.ts_Control.ts_ControlExecution.ts_P_discretizedBy_10.periodic_sense_timer.expired(1E10, current_time))) )))))
		{
			...
			{
				if((((((ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_T1.ts_InsertOrRemoveRod.ts_i_alternatesWith_r.ts_r_precede_i.autState == S0 && ( ((history[ts_TCS.i]-history[ts_TCS.r]) != 2) || (p0[ts_TCS.i] == '0') ) ) && (ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_T1.ts_InsertOrRemoveRod.ts_i_alternatesWith_r.ts_IbeforeR.autState == S0 && ( ((history[ts_TCS.r]-history[ts_TCS.i]) != 0) || (p0[ts_TCS.r] == '0') ) )) && (ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_T1.ts_InsertOrRemoveRod.ts_exclusion.autState == S0 && ((p0[ts_TCS.i] == '0') || (p0[ts_TCS.r] == '0')) )) && (ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_T1.ts_iUr.autState == S0 && ( (p0[ts_TCS.z]-'0') == ((p0[ts_TCS.r]-'0')+(p0[ts_TCS.i]-'0')) ) )) && ((ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_P_alternateWith_Z.ts_P_causality_Z.autState == S0 && ( (history[ts_TCS.p]+(p0[ts_TCS.p]-'0')) >= (history[ts_TCS.z]+(p0[ts_TCS.z]-'0')) ) ) && (ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_P_alternateWith_Z.ts_P_precede_Z.autState == S0 && ( ((history[ts_TCS.p]-history[ts_TCS.z]) != 1) || (p0[ts_TCS.p] == '0') ) ))))
				{
					...
					if(((ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_P_alternateWith_Z.ts_P_causality_Z.autState == S0 && ( (history[ts_TCS.p]+(p0[ts_TCS.p]-'0')) >= (history[ts_TCS.z]+(p0[ts_TCS.z]-'0')) ) ) && (ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_P_alternateWith_Z.ts_P_precede_Z.autState == S0 && ( ((history[ts_TCS.p]-history[ts_TCS.z]) != 1) || (p0[ts_TCS.p] == '0') ) )))
					{
						...
						{
							ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_P_alternateWith_Z.left_clock_P_causality_Z.reset_clock(current_time);ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_P_alternateWith_Z.ts_P_causality_Z.autState = S0;
							exec = 1;
						...
						{
							ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_P_alternateWith_Z.right_clock_P_precede_Z.reset_clock(current_time);ts_TCS.ts_Control.ts_ControlExecution.ts_TCS4.ts_P_alternateWith_Z.ts_P_precede_Z.autState = S0;
							exec = 1;
	...
	}else if((ts_TCS.autState == diagnostic && (((ts_TCS.ts_diagnostic.ts_D_alternateWith_C.ts_D_precede_C.autState == S0 && ( ((history[ts_TCS.d]-history[ts_TCS.c]) != 1) || (p0[ts_TCS.d] == '0') ) ) && (ts_TCS.ts_diagnostic.ts_D_alternateWith_C.ts_D_causality_C.autState == S0 && ( (history[ts_TCS.d]+(p0[ts_TCS.d]-'0')) >= (history[ts_TCS.c]+(p0[ts_TCS.c]-'0')) ) )) && (ts_TCS.ts_diagnostic.ts_S_subclock_C.autState == S0 && ((p0[ts_TCS.s] == '0') || (p0[ts_TCS.c] == '1')) ))))
	{
		if((((ts_TCS.ts_diagnostic.ts_D_alternateWith_C.ts_D_precede_C.autState == S0 && ( ((history[ts_TCS.d]-history[ts_TCS.c]) != 1) || (p0[ts_TCS.d] == '0') ) ) && (ts_TCS.ts_diagnostic.ts_D_alternateWith_C.ts_D_causality_C.autState == S0 && ( (history[ts_TCS.d]+(p0[ts_TCS.d]-'0')) >= (history[ts_TCS.c]+(p0[ts_TCS.c]-'0')) ) )) && (ts_TCS.ts_diagnostic.ts_S_subclock_C.autState == S0 && ((p0[ts_TCS.s] == '0') || (p0[ts_TCS.c] == '1')) )))
		{
			if(((ts_TCS.ts_diagnostic.ts_D_alternateWith_C.ts_D_precede_C.autState == S0 && ( ((history[ts_TCS.d]-history[ts_TCS.c]) != 1) || (p0[ts_TCS.d] == '0') ) ) && (ts_TCS.ts_diagnostic.ts_D_alternateWith_C.ts_D_causality_C.autState == S0 && ( (history[ts_TCS.d]+(p0[ts_TCS.d]-'0')) >= (history[ts_TCS.c]+(p0[ts_TCS.c]-'0')) ) )))
			{
				...
				{
					ts_TCS.ts_diagnostic.ts_D_alternateWith_C.left_clock_D_precede_C.reset_clock(current_time);ts_TCS.ts_diagnostic.ts_D_alternateWith_C.ts_D_precede_C.autState = S0;
					exec = 1;
				...
				{
					ts_TCS.ts_diagnostic.ts_D_alternateWith_C.right_clock_D_causality_C.reset_clock(current_time);ts_TCS.ts_diagnostic.ts_D_alternateWith_C.ts_D_causality_C.autState = S0;
					exec = 1;
...
int    backToDiagnostic(int  p0)
{
	...
	if((ts_TCS.autState == Control && ts_TCS.MIN < p0 < ts_TCS.MAX ))
	{
		...
		ts_TCS.ts_diagnostic.ts_D_alternateWith_C.right_clock_D_causality_C.reset_clock(last_event_time);
...
int main(int argc, char** argv)
{
	...
	ts_TCS.ts_diagnostic.ts_D_alternateWith_C.right_clock_D_causality_C.reset_clock(current_time);
