...
* ./environment diagnostic_trace diagnostic_clocks_index.txt control_trace control_clocks_index.txt --observer CCSL --output inputs_1.txt
...
* The --output option allows you to specify the output file containing the resulting traces after processing by the module.
